                    ...
                    <td colspan="4">
                        <table>
                            <tr>
                                ...
                                <td valign="bottom">
                                    <h3 style="letter-spacing:1px;">会员管理 > 修改会员 </h3>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <form action="member.let?type=modify" method="post">
                                        <table width="100%" class="cont">
                                            <tr>
                                                ...
                                                <td width="10%">用户编号：</td>
                                                <td width="20%">
                                                    <!--不能使用disabled，disabled不能将数据传给后台-->
                                                    <input class="text" type="text" name="id" value="${member.id}" readonly/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="10%">用户名：</td>
                                                <td width="20%">
                                                    <input class="text" type="text" name="name" value="${member.name}" readonly/></td>
                                                <td class="err">长度6~15个字符</td>
                                                <td width="2%">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>密码：</td>
                                                <td>
                                                    <input class="text" type="password" name="pwd" value="${member.pwd}" required/>
                                                </td>
